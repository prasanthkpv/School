 ...
 <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
          ...
          <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                  <a class="nav-link" href="DailyFeeReport.php">Payment Report</a>
                   <a class="nav-link active" href="ConsolidateFeeReport.php">Consolidate Report </a>
  ...
  <div class="sb-sidenav-footer">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Consolidate Fee Report</h1>
                        <ol class="breadcrumb mb-4">
                           <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Consolidate Fee Report</li>
                        </ol>
                        <!-- 
                        <div class="row">
     ...
     <div class="card-header">
          ...
          <span style="color: green;font-size: 20px; font-weight: bold;"> Consolidate Fee Report </span>
           <span style="padding-left: 75%;"> 
           <a type="Submit" href="fpdf/Fee_Report_Consolidate.php" class="btn btn-outline-danger btn-sm px-3 rounded-pill" role="button" aria-pressed="true" tabindex="3"><i class="fas fa-file-pdf" style="font-size: 20px"></i> </a> </span>
          </div>
     </div>
     <div class="card-body" >
<?php 
...
?>   
     ...
     <thead>
        <tr class="table-info border-warning">
           ...
           <th width="10%">Prev. Due</th>
           <th width="10%">Total Fee</th>
           <th width="10%">School Fee</th>
           <th width="10%">Trans. Fee</th>
           <th width="10%">Book Fee</th>
           <th width="10%">Misc. Fee</th>
...
?>     
          <tr <?php if(($i%2)==0) { echo "class=\"table-light border-warning\"";} else { echo "class=\"table-warning border-warning\""; } ?>>
              <td><?php echo $i + 1; ?></td>
              <td ><?php echo $ClassArray[$i] ?> </td>
              <td style="text-align: center;"><?php echo StudentCountFunction($ClassArray[$i]); ?></td>               
              <td style="text-align: right;"> <a class="btn btn-outline-dark btn-sm px-2" type="button" ><span id="EditDisplayPrevDue<?php echo $FetchStudent['AdmNO'];?>" >          
              <?php 
              ...
              <td style="text-align: right;"><a class="btn btn-outline-dark btn-sm px-2" type="button" > <span id="EditDisplayTotalFee<?php echo $FetchStudent['AdmNO'];?>" > 
             <?php 
              ...
              <td style="text-align: right;"><a class="btn btn-outline-dark btn-sm px-2" type="button" > <span  id="EditDisplayTerm1<?php echo $FetchStudent['AdmNO'];?>" > 
       			 <?php 
              ...
              <td style="text-align: right;"><a class="btn btn-outline-dark btn-sm px-2" type="button" > <span id="EditDisplayTerm2<?php echo $FetchStudent['AdmNO'];?>" >
               <?php $Term2	= ConsolidateFeeFunction($ClassArray[$i],"Term2");
       			 $TotalTerm2 = ($TotalTerm2 + $Term2);
       			 echo "&#8377; ".$Term2; ?>  </span></a> </td>
                
              <td style="text-align: right;"><a class="btn btn-outline-dark btn-sm px-2" type="button" > <span id="EditDisplayTerm3<?php echo $FetchStudent['AdmNO'];?>" > 
              <?php $Term3	= ConsolidateFeeFunction($ClassArray[$i],"Term3");
       			 $TotalTerm3 = ($TotalTerm3 + $Term3);
       			 echo "&#8377; ".$Term3; ?>  </span></a> </td>
               
              <td style="text-align: right;"><a class="btn btn-outline-dark btn-sm px-2" type="button"> <span id="EditDisplayTerm4<?php echo $FetchStudent['AdmNO'];?>" >
               <?php $Term4	= ConsolidateFeeFunction($ClassArray[$i],"Term4");
       			 $TotalTerm4 = ($TotalTerm4 + $Term4);
       			 echo "&#8377; ".$Term4; ?>  </span></a> </td>
               
              <td style="text-align: right;"><a class="btn btn-outline-dark btn-sm px-2" type="button"><span id="EditDisplayTotalPaid<?php echo $FetchStudent['AdmNO'];?>" >
              <?php $TotalPaid	= ConsolidateFeeFunction($ClassArray[$i],"TotalPaid");
       			 $TotalFeePaid = ($TotalFeePaid + $TotalPaid);
       			 echo "&#8377; ".$TotalPaid; ?> </span></a> </td>
               
              <td style="text-align: right;"><a class="btn btn-outline-dark btn-sm px-2" type="button"><span id="EditDisplayBalance<?php echo $FetchStudent['AdmNO'];?>">
              <?php $Balance	= ConsolidateFeeFunction($ClassArray[$i],"Balance");
       			 $TotalBalanace = ($TotalBalanace + $Balance);
       			 echo "&#8377; ".$Balance; ?></span></a> </td>
    ...
    <?php } ?> 
      ...
      <tfoot>
       <tr class="table-warning border-warning">
        <th colspan="3"style="text-align: center;" >GRANT TOTAL OF 1 TO <?php echo $i; ?> STUDENTS</th>          
        <th width="8%"style="text-align: right;"><a class="btn btn-outline-primary btn-sm px-2"  type="button" id="TotalDue" ><?php echo "&#8377; ".$TotalDue; ?> </a></th>
        <th width="8%"style="text-align: right;" ><a class="btn btn-outline-primary btn-sm px-2" type="button" id="GrantTotalFee"><?php echo "&#8377; ".$GrantTotalFee; ?> </a></th>
        <th width="8%"style="text-align: right;"><a class="btn btn-outline-primary btn-sm px-2" type="button"  id="TotalTerm1"><?php echo "&#8377; ".$TotalTerm1; ?></a></th>
        <th width="8%"style="text-align: right;"><a class="btn btn-outline-primary btn-sm px-2" type="button"  id="TotalTerm2"><?php echo "&#8377; ".$TotalTerm2; ?></a></th>
        <th width="8%"style="text-align: right;" ><a class="btn btn-outline-primary btn-sm px-2" type="button" id="TotalTerm3"><?php echo "&#8377; ".$TotalTerm3; ?></a></th>
        <th width="8%"style="text-align: right;" ><a class="btn btn-outline-primary btn-sm px-2" type="button" id="TotalTerm4"><?php echo "&#8377; ".$TotalTerm4; ?></a></th>
        <th width="8%"style="text-align: right;" ><a class="btn btn-outline-primary btn-sm px-2" type="button" id="TotalFeePaid"><?php echo "&#8377; ".$TotalFeePaid; ?></a></th>
        <th width="8%"style="text-align: right;" ><a class="btn btn-outline-primary btn-sm px-2" type="button" id="TotalBalanace"><?php echo "&#8377; ".$TotalBalanace; ?></a></th>
      <!--  <th width="2%">Edit</th> 
        <th width="2%"></th> -->
     </tr>
       </tfoot>        
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      ...
      <div class="row mb-3"><div class="col-md-3"><label for="Name" >Name</label></div><div class="col-md-9">
	   ...
	   <input class="form-control" id="FieldName" name="FieldName" type="text" disabled="disabled" placeholder="Amount Paid" />
		...
		<div class="row mb-3"><div class="col-md-3"><label for="Amount" >Amount</label>	</div><div class="col-md-9">
