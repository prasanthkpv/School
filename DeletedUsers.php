      ...
      <div class="nav">
          ...
          <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                  <a class="nav-link" href="DailyFeeReport.php">Report</a>
        ...
        <!--  
         <a class="nav-link" href="DeletedUsers.php">
          ...
          <a class="nav-link active" href="DeletedUsers.php">
                ...
                <main>
                    <div class="container-fluid px-4">
                       ...
                       <!--
                        ...
                        -->
<?php 
$sql = "SELECT * FROM DeletedUsers WHERE (Type = 'Student') ORDER BY SLN DESC";
...
?>                        
     ...
     <div class="card-header">
           ...
           <span style="color: green;font-size: 20px; font-weight: bold;"> Deleted Users </span>
           <span style="padding-left: 948px;"> 
           <a type="Submit" href="register.php" class="btn btn-success btn-sm active" role="button" aria-pressed="true" tabindex="3"><span style="padding:10px"> </span></a> </span>
          </div>
     </div>
     <div class="card-body" >
     ...
     <thead>
      ...
      $i = 0;
		do {
          ...
          <tr>
              <td><?php echo $i; ?></td>
              <td id="EditDisplayAdmNO<?php echo $FetchStudent['SLN'];?>"><?php echo $FetchStudent['AdmNO'] ; ?> </td>
              <td id="EditDisplayName<?php echo $FetchStudent['SLN'];?>"><?php echo strtoupper($FetchStudent['Firstname']." ".$FetchStudent['Lastname']); ?></td>
              <td id="EditDisplayGender<?php echo $FetchStudent['SLN'];?>"><?php echo $FetchStudent['Gender'] ; ?> </td>
              <td id="EditDisplayDOA<?php echo $FetchStudent['SLN'];?>"><?php echo $FetchStudent['DOA'] ; ?> </td>
              <td id="EditDisplayClass<?php echo $FetchStudent['SLN'];?>"><?php echo $FetchStudent['Class'] ; ?> </td>
              <td id="EditDisplayPhone<?php echo $FetchStudent['SLN'];?>"><?php echo $FetchStudent['Phone'] ; ?> </td>
              <td style="text-align: center;"><a class="btn btn-outline-primary btn-sm px-2 rounded-pill " type="button" data-bs-role="Update" data-bs-toggle="modal" data-bs-target="#myModal" data-id="<?php echo $FetchStudent['SLN']; ?>">Edit</a></td>
              <td style="text-align: center;"><a class="btn btn-outline-danger btn-sm px-3 rounded-pill" type="button" onclick="return confirm('Do you want to Delete')" href="Delete/UserDelete.php?SLN=<?php echo $FetchStudent['SLN']; ?>" ><i class="fa fa-trash"></i>
</a></td>
          </tr>
